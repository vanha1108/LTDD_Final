...
public class StudentAdminAdapter extends RecyclerView.Adapter<StudentAdminAdapter.MyViewHolder> {
    ...
    public interface OnLongClick {
        void dialogUpdateDeleteStudent(Student student);
    }

    public StudentAdminAdapter(Context context, ArrayList<Student> students, OnLongClick onLongClick) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                onLongClick.dialogUpdateDeleteStudent(student);
                return true;
            }
        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            myText1 = itemView.findViewById(R.id.txtStudentCode);
