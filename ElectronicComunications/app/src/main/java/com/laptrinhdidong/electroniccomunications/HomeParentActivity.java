...
public class HomeParentActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerHomeParent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerHomeParent = findViewById(R.id.recyclerHomeParent);
        ...
        recyclerHomeParent.setLayoutManager(linearLayoutManager);
        recyclerHomeParent.setAdapter(notificationAdapter);
    }
}